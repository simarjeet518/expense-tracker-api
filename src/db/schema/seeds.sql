...
VALUES ('Food'),('Grocery'),('Phone Bill'),('Gas Bill'),('Fun Money'),('Rent'),('Car Insurnace'),('shopping');

Insert INTO users_monthly_allowance(user_id, budget,year,month)
VALUES (1,5000,'2022','01');
